...
class CTickSwaySystem(CStrategy):
    ...
    def checkQuotation(self,quotation):
        ...
        if ((_tradingContract.position == 0) and (_tradingContract.dayTradingFlag == True) and (_tradingContract.tradeNum < self.maxTradeNum)):
            ...
            if ((quotation.updateTime > "09:15:00" and quotation.updateTime < "14:45:00")
                or (quotation.updateTime > "21:15:00") or (quotation.updateTime < "02:15:00")):
                # 如果卖一价大于买开仓价,且小于卖平仓价
                #	_tradingContract.priceTick为滑点

                if (_tradingContract.LT_QuotationList.up_volume_count  /(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count ) > _tradingContract.LT_Enter_Ratio
                    and _tradingContract.ST_QuotationList.up_volume_count  /(_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count )  > _tradingContract.ST_Enter_Ratio
                    and _tradingContract.LT_QuotationList.up_volume_count  /(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count ) < _tradingContract.ST_QuotationList.up_volume_count  /(_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count )
                ...
                # 如果买一价小于卖开仓价,PriceTick为滑点
                    ...
                    if (_tradingContract.LT_QuotationList.down_volume_count  /(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count )  > _tradingContract.LT_Enter_Ratio
                        and _tradingContract.ST_QuotationList.down_volume_count  /(_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count )  > _tradingContract.ST_Enter_Ratio
                        and _tradingContract.LT_QuotationList.down_volume_count  /(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count )  >  _tradingContract.ST_QuotationList.down_volume_count  /(_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count )
            ...
            if (_tradingContract.positionField.long_posi > 0 or _tradingContract.positionField.short_posi > 0 ):
                ...
                # 在非收市前2分钟，正常判断价格是否在平仓区间，是否达到止盈和止损平仓位
                    ...
                    if (_tradingContract.positionField.long_posi > 0 and _tradingContract.BuyorSell == THOST_FTDC_D_Buy):
                        if (_tradingContract.LT_QuotationList.up_tick_count  /_tradingContract.LT_QuotationList.MaxLength  > _tradingContract.ST_QuotationList.up_tick_count  /_tradingContract.ST_QuotationList.MaxLength   ):
                            _pInputOrder = CThostFtdcInputOrderField()
                    ...
                    # 卖持仓
                        ...
                        if (_tradingContract.positionField.short_posi > 0
                            and _tradingContract.LT_QuotationList.down_volume_count  /(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count )   <
                                    _tradingContract.ST_QuotationList.down_volume_count  / (_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count )  ):
...
class CTSSTradingContract(CTradingContract):
    ...
    def initialContract(self,instrumentID):
        # 入场阀值
        self.LT_Enter_Ratio = 0.52
        # 出场阀值
        self.LT_Exit_Ratio = 0.52
        #
        ...
        self.m1_QuotationList = CQuotationLinkList(120)
    ...
    def handleQuotation(self, quotation):
        ...
        if (quotation.updateTime[:5] >= '20:50' or quotation.updateTime[:5] <='15:00'  ):
            ...
            logging.debug(','+quotation.updateTime +','+
                            str(quotation.lastPrice) + ','
                          + str(_tradingContract.LT_QuotationList.up_volume_count)+','+str(_tradingContract.LT_QuotationList.down_volume_count)
                          + ',' + str(round(_tradingContract.LT_QuotationList.up_volume_count/(_tradingContract.LT_QuotationList.up_volume_count + _tradingContract.LT_QuotationList.down_volume_count),2))
                          + ',' + str(_tradingContract.ST_QuotationList.up_volume_count) + ',' + str(_tradingContract.ST_QuotationList.down_volume_count)
                          + ',' +  str(round(_tradingContract.ST_QuotationList.up_volume_count/(_tradingContract.ST_QuotationList.up_volume_count + _tradingContract.ST_QuotationList.down_volume_count),2))
                          + ',' + str(_tradingContract.m1_QuotationList.up_volume_count) + ',' + str(_tradingContract.m1_QuotationList.down_volume_count)
                          + ',' +  str(round(_tradingContract.m1_QuotationList.up_volume_count/(_tradingContract.m1_QuotationList.up_volume_count + _tradingContract.m1_QuotationList.down_volume_count),2))
                          + ','
                          )
