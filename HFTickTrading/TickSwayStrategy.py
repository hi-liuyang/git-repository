    ...
    def checkQuotation(self,quotation):
        ...
        if ((_tradingContract.position == 0) and (_tradingContract.dayTradingFlag == True) and (_tradingContract.tradeNum < self.maxTradeNum)):
            ...
            if ((quotation.updateTime > "09:15:00" and quotation.updateTime < "14:25:00")
                ...
                if (_tradingContract.QuotationList.up_tick_count  /_tradingContract.QuotationList.MaxLength > _tradingContract.Enter_Ratio and _tradingContract.positionField.long_order == 0 ) :
                ...
                # 如果买一价小于卖开仓价,PriceTick为滑点
                    ...
                    if (_tradingContract.QuotationList.down_tick_count  /_tradingContract.QuotationList.MaxLength > _tradingContract.Enter_Ratio and _tradingContract.positionField.short_order == 0 ):
                        _tradingContract.position = 1
            ...
            if (_tradingContract.positionField.long_posi > 0 or _tradingContract.positionField.short_posi > 0 ):
                ...
                # 在非收市前2分钟，正常判断价格是否在平仓区间，是否达到止盈和止损平仓位
                    ...
                    if (_tradingContract.positionField.long_posi > 0 and _tradingContract.BuyorSell == THOST_FTDC_D_Buy):
                        if (_tradingContract.QuotationList.up_tick_count  /_tradingContract.QuotationList.MaxLength  < _tradingContract.Exit_Ratio ):
                            _pInputOrder = CThostFtdcInputOrderField()
                    ...
                    # 卖持仓
                        ...
                        if (_tradingContract.positionField.short_posi > 0 and _tradingContract.QuotationList.down_tick_count  /_tradingContract.QuotationList.MaxLength  < _tradingContract.Exit_Ratio ):
...
class CTSSTradingContract(CTradingContract):
    ...
    def initialContract(self,instrumentID):
        # 入场阀值
        self.Enter_Ratio = 0.53
        # 出场阀值
        self.Exit_Ratio = 0.50
        #
        self.QuotationList = CQuotationLinkList(600)
...
class CTSSMdHandler(CMdHandler):
    ...
    def handleQuotation(self, quotation):
        ...
        if (quotation.updateTime[:5] >= '20:50' or quotation.updateTime[:5] <='15:00'  ):
            ...
            _tradingContract.QuotationList.append(quotation)
